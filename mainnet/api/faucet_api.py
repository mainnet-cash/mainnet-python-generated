...
class FaucetApi(object):
    ...
    def get_testnet_sbch(self, get_testnet_sbch_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_testnet_sbch(get_testnet_sbch_request, async_req=True)
        >>> result = thread.get()

        :param get_testnet_sbch_request: Request to bch faucet  (required)
        :type get_testnet_sbch_request: GetTestnetSbchRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetTestnetSbchResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.get_testnet_sbch_with_http_info(get_testnet_sbch_request, **kwargs)  # noqa: E501

    def get_testnet_sbch_with_http_info(self, get_testnet_sbch_request, **kwargs):  # noqa: E501
        """Request testnet SmartBCH funds. The request is enqueued and served within 1-3 block confirmations. If the target address holds more that 0.1 BCH, the request will fail. Otherwise the address will be topped up to 0.1 BCH.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_testnet_sbch_with_http_info(get_testnet_sbch_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetTestnetSbchResponse, status_code(int), headers(HTTPHeaderDict))
        """

        local_var_params = locals()

        all_params = [
            'get_testnet_sbch_request'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_testnet_sbch" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'get_testnet_sbch_request' is set
        if self.api_client.client_side_validation and ('get_testnet_sbch_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['get_testnet_sbch_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `get_testnet_sbch_request` when calling `get_testnet_sbch`")  # noqa: E501
        ...
        body_params = None
        if 'get_testnet_sbch_request' in local_var_params:
            body_params = local_var_params['get_testnet_sbch_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetTestnetSbchResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_testnet_sep20(self, get_testnet_sep20_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_testnet_sep20(get_testnet_sep20_request, async_req=True)
        >>> result = thread.get()

        :param get_testnet_sep20_request: Request to SEP20 faucet  (required)
        :type get_testnet_sep20_request: GetTestnetSep20Request
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetTestnetSep20Response
        """
        kwargs['_return_http_data_only'] = True
        return self.get_testnet_sep20_with_http_info(get_testnet_sep20_request, **kwargs)  # noqa: E501

    def get_testnet_sep20_with_http_info(self, get_testnet_sep20_request, **kwargs):  # noqa: E501
        """Request testnet SmartBch SEP20 tokens. The request is enqueued and served within 1-3 block confirmations. If the target address holds more that 10 tokens of requested kind, the request will fail. Otherwise the address will be topped up to 10 tokens.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_testnet_sep20_with_http_info(get_testnet_sep20_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetTestnetSep20Response, status_code(int), headers(HTTPHeaderDict))
        """

        local_var_params = locals()

        all_params = [
            'get_testnet_sep20_request'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_testnet_sep20" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'get_testnet_sep20_request' is set
        if self.api_client.client_side_validation and ('get_testnet_sep20_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['get_testnet_sep20_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `get_testnet_sep20_request` when calling `get_testnet_sep20`")  # noqa: E501
        ...
        body_params = None
        if 'get_testnet_sep20_request' in local_var_params:
            body_params = local_var_params['get_testnet_sep20_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetTestnetSep20Response',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
