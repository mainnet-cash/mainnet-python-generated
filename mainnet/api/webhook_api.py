...
class WebhookApi(object):
    ...
    def watch_address(self, watch_address_request, **kwargs):  # noqa: E501
        ...
        :param watch_address_request: Based on the 'type' parameter the webhook will be triggered to either post balance or raw transactions to the 'url' - 'transaction:in' for incoming only, 'transaction:out' for outgoing only and 'transaction:in,out' both for incoming and outgoing transactions. 'balance' will post the object according to 'BalanceResponse' schema  (required)
