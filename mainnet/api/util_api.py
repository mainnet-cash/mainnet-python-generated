...
class UtilApi(object):
    ...
    def convert_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ConvertResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def exchange_rate(self, **kwargs):  # noqa: E501
        """convert between units  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.exchange_rate(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.exchange_rate_with_http_info(**kwargs)  # noqa: E501

    def exchange_rate_with_http_info(self, **kwargs):  # noqa: E501
        """convert between units  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.exchange_rate_with_http_info(async_req=True)
        >>> result = thread.get()
