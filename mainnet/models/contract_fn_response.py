...
class ContractFnResponse(object):
    ...
    def __init__(self, contract_id=None, tx_id=None, hex=None, debug=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def debug(self):
        """Gets the debug of this ContractFnResponse.  # noqa: E501

        if a debugger action is passed in the request, the result will return here.  # noqa: E501

        :return: The debug of this ContractFnResponse.  # noqa: E501
        :rtype: str
        """
        return self._debug
    ...
    def debug(self, debug):
        """Sets the debug of this ContractFnResponse.

        if a debugger action is passed in the request, the result will return here.  # noqa: E501

        :param debug: The debug of this ContractFnResponse.  # noqa: E501
        :type debug: str
        """
