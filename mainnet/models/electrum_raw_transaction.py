...
class ElectrumRawTransaction(object):
    ...
    def __init__(self, blockhash=None, blocktime=None, configrmations=None, hash=None, hex=None, locktime=None, size=None, time=None, txid=None, version=None, vin=None, vout=None, local_vars_configuration=None):  # noqa: E501
        ...
        if configrmations is not None:
            self.configrmations = configrmations
        if hash is not None:
            self.hash = hash
        if hex is not None:
            self.hex = hex
    ...
    @property
    def configrmations(self):
        """Gets the configrmations of this ElectrumRawTransaction.  # noqa: E501


        :return: The configrmations of this ElectrumRawTransaction.  # noqa: E501
        :rtype: float
        """
        return self._configrmations

    @configrmations.setter
    def configrmations(self, configrmations):
        """Sets the configrmations of this ElectrumRawTransaction.


        :param configrmations: The configrmations of this ElectrumRawTransaction.  # noqa: E501
        :type configrmations: float
        """

        self._configrmations = configrmations
