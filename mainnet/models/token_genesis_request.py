...
class TokenGenesisRequest(object):
    ...
    openapi_types = {
        'wallet_id': 'str',
        'requests': 'list[TokenGenesisItem]',
    ...
    def __init__(self, wallet_id=None, requests=None, send_requests=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def requests(self):
        """Gets the requests of this TokenGenesisRequest.  # noqa: E501

        One or more genesis requests. Each consumes a distinct vout=0 input and creates a new token category in the same transaction.  # noqa: E501

        :return: The requests of this TokenGenesisRequest.  # noqa: E501
        :rtype: list[TokenGenesisItem]
        """
        return self._requests

    @requests.setter
    def requests(self, requests):
        """Sets the requests of this TokenGenesisRequest.

        One or more genesis requests. Each consumes a distinct vout=0 input and creates a new token category in the same transaction.  # noqa: E501

        :param requests: The requests of this TokenGenesisRequest.  # noqa: E501
        :type requests: list[TokenGenesisItem]
        """
