...
class TokenBurnRequest(object):
    ...
    def __init__(self, wallet_id=None, requests=None, message=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def requests(self):
        """Gets the requests of this TokenBurnRequest.  # noqa: E501

        One or more burn requests. Requests can span multiple categories, all burned in a single transaction sharing one OP_RETURN.  # noqa: E501

        :return: The requests of this TokenBurnRequest.  # noqa: E501
        :rtype: list[TokenBurnItem]
        """
        return self._requests

    @requests.setter
    def requests(self, requests):
        """Sets the requests of this TokenBurnRequest.

        One or more burn requests. Requests can span multiple categories, all burned in a single transaction sharing one OP_RETURN.  # noqa: E501

        :param requests: The requests of this TokenBurnRequest.  # noqa: E501
        :type requests: list[TokenBurnItem]
        """
