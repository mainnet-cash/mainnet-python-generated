...
class ContractFnRequest(object):
    ...
    def action(self):
        ...
        In addition to `send`ing the built transaction, the built transaction hex may be returned (without broadcasting) with `build` action.  # noqa: E501
    ...
    def action(self, action):
        ...
        :type action: str
        """
        allowed_values = ["build", "send"]  # noqa: E501
