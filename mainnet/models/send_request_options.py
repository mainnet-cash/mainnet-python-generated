...
class SendRequestOptions(object):
    ...
    def __init__(self, utxo_ids=None, change_address=None, slp_aware=False, slp_semi_aware=False, query_balance=True, await_transaction_propagation=True, local_vars_configuration=None):  # noqa: E501
